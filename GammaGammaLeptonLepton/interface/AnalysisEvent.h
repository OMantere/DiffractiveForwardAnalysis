...
namespace ggll
{
  ...
  class AnalysisEvent
  {
    public:
      ...
      unsigned int nGenRMuonCand;
      double GenRMuonCand_pt[MAX_GENMU], GenRMuonCand_eta[MAX_GENMU], GenRMuonCand_phi[MAX_GENMU], GenRMuonCand_e[MAX_GENMU];
      unsigned int nGenREleCand;
      double GenREleCand_pt[MAX_GENMU], GenREleCand_eta[MAX_GENMU], GenREleCand_phi[MAX_GENMU], GenREleCand_e[MAX_GENMU];
      unsigned int nGenChi10Cand;
      double GenChi10Cand_pt[MAX_GENMU], GenChi10Cand_eta[MAX_GENMU], GenChi10Cand_phi[MAX_GENMU], GenChi10Cand_e[MAX_GENMU];
      ...
      double GenSLRPair_pt, GenSLRPair_eta, GenSLRPair_phi, GenSLRPair_mass;
      double GenSLRPair_dphi, GenSLRPair_dpt, GenSLRPair_3Dangle;
      double GenChi10Pair_pt, GenChi10Pair_eta, GenChi10Pair_phi, GenChi10Pair_mass;
      double GenChi10Pair_dphi, GenChi10Pair_dpt, GenChi10Pair_3Dangle;
      ...
      void attach( TTree* tree, TreeType tt, bool mc ) {
        ...
        if ( tt == ElectronMuon || tt == DiMuon ) {
          ...
          if ( mc ) {
            ...
            tree->Branch( "nGenRMuonCand", &nGenRMuonCand, "nGenRMuonCand/i" );
            tree->Branch( "GenRMuonCand_pt", GenRMuonCand_pt, "GenRMuonCand_pt[nGenRMuonCand]/D" );
            tree->Branch( "GenRMuonCand_eta", GenRMuonCand_eta, "GenRMuonCand_eta[nGenRMuonCand]/D" );
            tree->Branch( "GenRMuonCand_phi", GenRMuonCand_phi, "GenRMuonCand_phi[nGenRMuonCand]/D" );
            tree->Branch( "GenRMuonCand_e", GenRMuonCand_e, "GenRMuonCand_e[nGenRMuonCand]/D" );
            tree->Branch( "nGenChi10Cand", &nGenChi10Cand, "nGenChi10Cand/i" );
            tree->Branch( "GenChi10Cand_pt", GenChi10Cand_pt, "GenChi10Cand_pt[nGenChi10Cand]/D" );
            tree->Branch( "GenChi10Cand_eta", GenChi10Cand_eta, "GenChi10Cand_eta[nGenChi10Cand]/D" );
            tree->Branch( "GenChi10Cand_phi", GenChi10Cand_phi, "GenChi10Cand_phi[nGenChi10Cand]/D" );
            tree->Branch( "GenChi10Cand_e", GenChi10Cand_e, "GenChi10Cand_e[nGenChi10Cand]/D" );
          }
        }
        ...
        if ( mc ) {
          ...
          tree->Branch( "GenSLRPair_mass", &GenSLRPair_mass, "GenSLRPair_mass/D" );
          tree->Branch( "GenSLRPair_pt", &GenSLRPair_pt, "GenSLRPair_pt/D" );
          tree->Branch( "GenSLRPair_eta", &GenSLRPair_eta, "GenSLRPair_eta/D" );
          tree->Branch( "GenSLRPair_phi", &GenSLRPair_phi, "GenSLRPair_phi/D" );
          tree->Branch( "GenSLRPair_dpt", &GenSLRPair_dpt, "GenSLRPair_dpt/D" );
          tree->Branch( "GenSLRPair_dphi", &GenSLRPair_dphi, "GenSLRPair_dphi/D" );
          tree->Branch( "GenSLRPair_3Dangle", &GenSLRPair_3Dangle, "GenSLRPair_3Dangle/D" );
          tree->Branch( "GenChi10Pair_mass", &GenChi10Pair_mass, "GenChi10Pair_mass/D" );
          tree->Branch( "GenChi10Pair_pt", &GenChi10Pair_pt, "GenChi10Pair_pt/D" );
          tree->Branch( "GenChi10Pair_eta", &GenChi10Pair_eta, "GenChi10Pair_eta/D" );
          tree->Branch( "GenChi10Pair_phi", &GenChi10Pair_phi, "GenChi10Pair_phi/D" );
          tree->Branch( "GenChi10Pair_dpt", &GenChi10Pair_dpt, "GenChi10Pair_dpt/D" );
          tree->Branch( "GenChi10Pair_dphi", &GenChi10Pair_dphi, "GenChi10Pair_dphi/D" );
          tree->Branch( "GenChi10Pair_3Dangle", &GenChi10Pair_3Dangle, "GenChi10Pair_3Dangle/D" );
        }
      ...
      void load( TTree* tree, TreeType tt, bool mc ) {
        ...
        if ( tt == ElectronMuon || tt == DiMuon ) {
          ...
          if ( mc ) {
            ...
            tree->SetBranchAddress( "nGenRMuonCand", &nGenRMuonCand );
            tree->SetBranchAddress( "GenRMuonCand_pt", GenRMuonCand_pt );
            tree->SetBranchAddress( "GenRMuonCand_eta", GenRMuonCand_eta );
            tree->SetBranchAddress( "GenRMuonCand_phi", GenRMuonCand_phi );
            tree->SetBranchAddress( "GenRMuonCand_e", GenRMuonCand_e );
            tree->SetBranchAddress( "nGenChi10Cand", &nGenChi10Cand );
            tree->SetBranchAddress( "GenChi10Cand_pt", GenChi10Cand_pt );
            tree->SetBranchAddress( "GenChi10Cand_eta", GenChi10Cand_eta );
            tree->SetBranchAddress( "GenChi10Cand_phi", GenChi10Cand_phi );
            tree->SetBranchAddress( "GenChi10Cand_e", GenChi10Cand_e );
          }
        }
        ...
        if ( mc ) {
          ...
          tree->SetBranchAddress( "GenSLRPair_mass", &GenSLRPair_mass );
          tree->SetBranchAddress( "GenSLRPair_pt", &GenSLRPair_pt );
          tree->SetBranchAddress( "GenSLRPair_eta", &GenSLRPair_eta );
          tree->SetBranchAddress( "GenSLRPair_phi", &GenSLRPair_phi );
          tree->SetBranchAddress( "GenSLRPair_dpt", &GenSLRPair_dpt );
          tree->SetBranchAddress( "GenSLRPair_dphi", &GenSLRPair_dphi );
          tree->SetBranchAddress( "GenSLRPair_3Dangle", &GenSLRPair_3Dangle );
          tree->SetBranchAddress( "GenChi10Pair_mass", &GenChi10Pair_mass );
          tree->SetBranchAddress( "GenChi10Pair_pt", &GenChi10Pair_pt );
          tree->SetBranchAddress( "GenChi10Pair_eta", &GenChi10Pair_eta );
          tree->SetBranchAddress( "GenChi10Pair_phi", &GenChi10Pair_phi );
          tree->SetBranchAddress( "GenChi10Pair_dpt", &GenChi10Pair_dpt );
          tree->SetBranchAddress( "GenChi10Pair_dphi", &GenChi10Pair_dphi );
          tree->SetBranchAddress( "GenChi10Pair_3Dangle", &GenChi10Pair_3Dangle );
        }
